...
export class PostDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('overheardReactApp.post.delete.question'));
...
export default class PostComponentsPage {
  ...
  async deletePost() {
    ...
    expect(await postDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/overheardReactApp.post.delete.question/);
