...
/**
 * REST controller for managing {@link com.panda.overheard.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    public ResponseEntity<Post> updatePost(@Valid @RequestBody Post post) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, post.getId()))
            .body(result);
    }
