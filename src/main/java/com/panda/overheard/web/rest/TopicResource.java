...
/**
 * REST controller for managing {@link com.panda.overheard.domain.Topic}.
 */
@RestController
@RequestMapping("/api")
public class TopicResource {
    ...
    public ResponseEntity<Topic> updateTopic(@Valid @RequestBody Topic topic) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, topic.getId()))
            .body(result);
    }
